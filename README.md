...
в Python нет разделения на тип данных 'char' и "string"
```sh
n = 6
n = none
n = "somestring"
...
- Интерполяция - получение сложной строки из нескольких простых:
  Конструкцтя f "{var1} - (var2) - ..." позволяет выводить данные внутри переменных:
...
Список это +- тот же массив
Задать список можно разными способами:
```sh
